...
const Profile = () => {
  return (
    <div className='flex flex-col w-full bg-white dark:bg-black'>
      <div className='flex flex-row items-center text-black dark:text-white p-2'>
      ...
      <div className='flex flex-row justify-end p-3'>
        <button type='button' className='flex p-2 text-black dark:text-white font-bold rounded-3xl border-slate-400'
          style={{borderWidth: 1}}
        >
          Editar Perfil
        </button>
      ...
      <div className='flex flex-col p-4'>
        <div>
          <p className='text-black dark:text-white font-bold text-xl'>{profile.name}</p>
        ...
        <div className='flex flex-row text-sm gap-2 mt-2'>
          <p className='text-slate-400'><span className='text-black dark:text-white font-bold'>{profile.following}</span> Siguiendo</p>
          <p className='text-slate-400'><span className='text-black dark:text-white font-bold'>{profile.followers}</span> Seguidores</p>
        </div>
